...
export const apl = build([
  {
    ...
    condition: describe(
      and(
        hasResource(RESOURCE_TYPES.CHI, { atMost: 4 }),
        hasResource(RESOURCE_TYPES.ENERGY, {
          // over 90% of max energy
          atLeast:
            (BASE_ENERGY_MAX +
  ...
  },
  {
    ...
    condition: buffPresent(SPELLS.WHIRLING_DRAGON_PUNCH_USABLE),
  },
  ...
  TALENTS.CHI_BURST_WINDWALKER_TALENT,
  {
